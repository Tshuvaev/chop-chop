...
function SampleRow({ segment, language = "en", onChange, onPreview, onDownload, isPlaying, playheadTime, isDownloading }) {
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0 flex-1">
          <div className="flex min-h-[22px] items-center justify-between gap-2">
            <div className="min-w-0 flex min-h-[22px] flex-1 items-center">
              <p className="pixel-title truncate text-[9px] leading-none text-[var(--pixel-text)] md:text-[10px]">
                {sampleName}
              </p>
            </div>
