...
from backend.utils.config import MAX_VIDEO_SECONDS
...
def validate_youtube_url(url: str) -> None:
    ...
    is_youtube_host = host == "youtu.be" or host.endswith(".youtu.be") or host == "youtube.com" or host.endswith(".youtube.com")
